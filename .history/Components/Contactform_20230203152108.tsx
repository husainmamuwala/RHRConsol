...
const ContactForm: React.FC = () => {
    ...
    const onSubmit = (e: FormEvent<HTMLFormElement>) => {
        ...
        // emailjs
        //     .send(
        //         process.env.EMAILJS_CONTACT_SERVICE_ID!,
    ...
    return (
        <div className="bg-[#1C2C5E]  text-white px-10 lg:px-20 py-10 lg:py-20">
            <h2 className="text-lg lg:text-xl">Contact Form</h2>
            <form
                onSubmit={onSubmit}
                ref={form}
                id="form"
                className="mt-6 lg:mt-12 flex flex-col gap-y-4"
            >
                <label className="text-sm lg:text-base" htmlFor="name">
                    Your Name
                    <span className="flex mt-2 border-2 border-white items-center pl-4">
                        <svg
                            width="38"
                            height="38"
                            className="w-7"
                        ...
                        <input
                            ...
                            className="bg-transparent w-3/4 outline-none
                                ml-4 placeholder-white placeholder-opacity-80 placeholder-shown:text-[0.75rem] placeholder-shown:font-light"
                            type="text"
                            name="name"
                ...
                <label className="text-sm lg:text-base" htmlFor="phone">
                    ...
                    <span className="flex mt-2 border-2 border-white items-center pl-4">
                        ...
                        <input
                            required
                            className="bg-transparent w-3/4 outline-none
                                ml-4 placeholder-[#FFCA05] placeholder-opacity-80 placeholder-shown:text-[0.75rem] placeholder-shown:font-light"
                            type="text"
                            name="phone"
                ...
                <label className="text-sm lg:text-base" htmlFor="email">
                    ...
                    <span className="flex mt-2 border-2 border-white items-center pl-4">
                        ...
                        <input
                            required
                            className="bg-transparent w-3/4 outline-none
                                ml-4 placeholder-[#1C1C1C] placeholder-opacity-80 placeholder-shown:text-[0.75rem] placeholder-shown:font-light"
                            type="email"
                            name="email"
                ...
                <label className="text-sm lg:text-base" htmlFor="message">
                    Your Message
                    <span className="flex mt-2 border-2 border-white items-start pt-2 pl-4">
                        <svg
                            className=" w-7 -mt-2"
                            width="39"
                            height="39"
                        ...
                        <textarea
                            ...
                            className="bg-transparent h-28 w-3/4 outline-none
                                ml-4 placeholder placeholder-opacity-80 placeholder-shown:text-[0.75rem] placeholder-shown:font-light"
                            name="message"
                ...
                <button
                    className="bg-[#1c1c1c] mt-4 lg:mt-8 text-primary text-lg w-max px-6 py-2 
                        border-[#1c1c1c] hover:border-2 hover:text-[#1c1c1c] hover:bg-transparent
                        active:border-2 active:text-[#1c1c1c] active:bg-transparent
                        active:scale-90
