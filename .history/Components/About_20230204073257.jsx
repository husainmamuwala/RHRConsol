...
const About = () => {
    ...
    return (
        <div className='px-10 flex lg:flex-row flex-col py-14 pb-10'>
            <div className='lg:w-3/5'>
                ...
                <div className='mt-1'>
                    ...
                    <div className='py-5'>
                    <button className="bg-[#FFCA05] rounded-xl px-5 py-[0.3rem] text-[#1C2C5E] font-normal fon lg:w-48 text-md
