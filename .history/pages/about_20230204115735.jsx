  ...
  return (
    <div>
      ...
      <div className='py-20 px-10'>
        <div className='bg-secondary text-white px-10 py-10 rounded-2xl flex md:flex-row'>
          <div className='h-48 w-1/2'>
          <img
          src='img/nvocc.jpg'
          className='rounded-2xl object-cover h-48 w-48'/>
          </div>
          <div className='flex flex-col px-10 w-6/12'>
