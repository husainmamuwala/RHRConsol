      ...
      <div className='bg-secondary w-full rounded-[2rem] md:py-10 py-5 md:px-10 px-5'>
        ...
        <div className='py-5 flex md:flex-row flex-col mt-5'>
          ...
          <div className='pr-28 ml-5'>
            ...
            <p className='text-white pr-32'>Our cargo be it Airport to Airport or Door to Door, for prompt movement, we have dedicated team & active network to provide round the clock services as per priority implies</p>
          </div>
        </div>
      </div>
    </div>
