...
const Footer = () => {
  ...
  return (
    ...
    <div className='w-full h-auto text-sm text-center py-2'>
    <svg
              className="w-full md:w-full px-24 md:stroke-1 stroke-3"
              width="auto"
              height="24"
              viewBox="0 0 262 5"
              fill="none"
            ...
            >
              <line x1="0.988506"y1="3.50004"x2="261.988"y2="1.50004"stroke="#FFCA05"stroke-width="auto"/>
            </svg>
      <span className='text-white' >© RHR Consol India Pvt Ltd</span>
      {" | "}
      <a
