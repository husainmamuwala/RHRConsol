                ...
                <div className='grid grid-cols-2 md:grid-cols-3 md:px-10 gap-y-10 lg:gap-x-14 place-items-center'>
                    {
                        Data.map((d) => (
                            <div className='bg-secondary rounded-2xl w-full'>
                                <div className='lg:h-32 lg:w-48 w-full self-center rounded-lg flex' key={d.title}>
                                    <img
                                        src={d.src}
                                        className='object-cover h-32 md:w-48 rounded-lg' />
                                    <div className=''>
                                        <p className='text-lg font-semibold px-5 w-1/2'>{d.title}</p>
                                    </div>
                                </div>
                            </div>
                        ))
