...
const Footer = () => {
  ...
  return (
    <div className='bg-[#1C2C5E] text-white py-8 flex md:flex-row flex-col items-center gap-y-6 md:justify-around'>
      ...
      width="auto" height="300" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" className='w-full md:px-20 py-6' style="filter:invert(90%)"></iframe>
      </div>
