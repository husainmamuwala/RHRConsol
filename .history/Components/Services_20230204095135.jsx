      ...
      <div className='bg-secondary w-full rounded-[2rem] md:py-10 py-5 md:px-10 px-5'>
        ...
        <div className='py-5 flex md:flex-row flex-col mt-5'>
          ...
          <div className='pr-28'>
            ...
            <div className='flex flex-row justify-between mt-5 m'>
              <p className='text-white font-semibold text-3xl'>
                <span className='text-primary'>WORLDWIDE </span>Shipping</p>
              <img
                src='img/a2.png' />
            </div>
            <p className='text-white'>our cargo be it Airport to Airport or Door to Door, for prompt movement, we have dedicated team & active network to provide round the clock services as per priority implies</p>
          </div>
        </div>
      </div>
    </div>
