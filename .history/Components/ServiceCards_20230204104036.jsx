    ...
    return (
        <div>
            <div className='items-center'>
                <div className='grid grid-cols-2 md:grid-cols-2 md:px-10 gap-y-10 lg:gap-x-14 place-items-center'>
                    {
                        Data.map((d) => (
                            <div className='bg-secondary rounded-2xl w-full'>
                                <div className='lg:h-auto self-center rounded-lg flex' key={d.title}>
                                    <img
                                        src={d.src}
