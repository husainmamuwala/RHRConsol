  ...
  return (
    <div>
      <div className=" grid lg:grid-cols-3 grid-rows-3 px-10 mt-10">
        {
        Data.map((d)=>(
        <div className="bg-[#1C2C5E] w-full rounded-xl lg:p-7" key={d.title}>
          <div className="flex flex-col">
            <div className="flex">
              ...
              <div>
                <p className="text-white self-end text-xl font-semibold pl-5">{d.title}</p>
              </div>
            </div>
          </div>
          <div>
            <svg
              className="w-[10rem] lg:w-[15rem] items-end"
              width="auto"
              height="24"
              viewBox="0 0 262 5"
              fill="none"
