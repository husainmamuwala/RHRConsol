...
const Services = () => {
  const Data = [
    ...
    },
    {
      ...
      sub:"Shipping",
      icon:"img/a2.png",
      desc:"Road transport is a flexible and cost-effective solution for the delivery of goods and cargo. We specializes in the transportation of goods by road, offering services such as trucking, freight brokerage, and delivery management.",
