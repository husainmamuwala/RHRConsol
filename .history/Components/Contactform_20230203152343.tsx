...
const ContactForm: React.FC = () => {
    ...
    return (
        <div className=" bg-[#FFCA05] text-white px-10 lg:px-20 py-10 lg:py-20">
            ...
            >
                ...
                <label className="text-sm lg:text-base" htmlFor="phone">
                    ...
                    <span className="flex mt-2 border-2 border-white items-center pl-4">
                        ...
                        <input
                            required
                            className="bg-transparent w-3/4 outline-none
                                ml-4 placeholder-black placeholder-opacity-80 placeholder-shown:text-[0.75rem] placeholder-shown:font-light"
                            type="text"
                            name="phone"
                ...
                <label className="text-sm lg:text-base" htmlFor="email">
                    Your Email
                    <span className="flex mt-2 border-2 border-black items-center pl-4">
                        <svg
                            className="w-7"
                            width="38"
                            height="38"
