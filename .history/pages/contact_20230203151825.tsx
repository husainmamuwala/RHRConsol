...
const contact :React.FC = () => {
  ...
  const ContactSect: React.FC = () => {
    ...
    return (
        ...
        lg:grid-cols-2"
        >
            <div className="bg-[#FFCA05] px-10 lg:px-20 py-10 lg:py-20">
                <h2 className="text-[#1C2C5E] font-medium text-lg lg:text-xl ">
                    Address
                </h2>
                <h3 className="mt-6 lg:mt-12 lg:text-lg tracking-wider text-[#1C2C5E]">
