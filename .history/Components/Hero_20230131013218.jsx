...
const Hero = () => {
  return (
    <div>
        ...
        <p className='font-mulish font-extrabold lg:text-6xl tracking-wide'>FAST,<span className='text-[#FFCA05] tracking-wide'>RELIABLE</span></p>
        <p className='lg:text-6xl tracking-wide'>TRANSPORTATION.</p>
