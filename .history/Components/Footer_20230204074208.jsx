...
const Footer = () => {
  ...
  return (
    <div className='bg-[#1C2C5E] text-white pt-8 flex md:flex-row flex-col items-center gap-y-6 md:justify-around'>
    ...
    <div className='bg-primary w-full h-auto text-sm text-center'>
      <span className='py-3'>© RHR Consol India Pvt Ltd</span>
      <br/>{" "}
      <a
