    ...
    <div className="w-full top-0 px-5 bg-[#1C2C5E]">
      <div className="lg:flex justify-between lg:items-center flex py-2">
        <div className="flex flex-row">
          <a href="/">
          <svg
          className="w-16 h-16 flex flex-col " width="auto" height="auto" viewBox="0 0 86 98" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <p className="text-white">RHR Consol India</p>
          </a>
        </div>
        <div
