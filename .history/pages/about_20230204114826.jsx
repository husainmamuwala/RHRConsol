    ...
    <div>
      ...
      <div className='py-20 px-10'>
        <div className='bg-secondary text-white px-10 py-10 rounded-2xl'>
          ...
          <p> Leads the various segment of Logistics which are Sea Cargo Consolidation for export and Import. Team Leader is a young and dynamic outfit headed by a vibrant and an ambitious management team with good experience of many years in the field of shipping & logistics.
