...
const About = () => {
    ...
    return (
        <div className='px-5 md:px-10 flex lg:flex-row flex-col py-14 pb-10'>
            <div className='lg:w-3/5'>
                ...
                <div className='mt-1'>
                    <p className='text-lg text-left leading-7 break-all'>
                    ...
                    <button className="bg-primary rounded-xl px-5 py-[0.3rem] text-black font-normal lg:w-48 text-md
            ...
            <div className='lg:w-2/3 items-center'>
                <div className='grid grid-cols-2 md:grid-cols-3 md:px-10 gap-y-10 lg:gap-x-14 place-items-center py-10'>
                    {
                        Data.map((d) => (
                            <div className='lg:h-32 lg:w-48 w-32 pr-2 self-center rounded-lg' key={d.title}>
                                <img
                                    src={d.src}
