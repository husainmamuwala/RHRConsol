        ...
        <div className='py-5 px-5'>
            <div className='items-center'>
                <div className='grid grid-cols-1 md:grid-cols-2 md:px-10 gap-y-10 lg:gap-x-14 place-items-center'>
                    {
                        Data.map((d) => (
                            <div className='bg-secondary rounded-2xl w-full' key={d.title}>
                                <div className='lg:h-auto self-center rounded-lg flex md:flex-row flex-col py-2 px-2'>
                                    <img
                                        src={d.src}
                                        className='object-cover md:w-48 w-full h-32 md:h-auto rounded-xl' />
                                    <div className=' mt-1 md:px-5'>
                                        <p className='text-lg font-bold text-primary uppercase '>{d.title}</p>
