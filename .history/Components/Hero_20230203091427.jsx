...
const Hero = () => {
  return (
    <div>
        ...
        className=' relative w-full bg-contain h-[20rem] lg:h-auto object-cover relative'/>
        <div className='z-10 absolute lg:top-10 top-0 lg:ml-10 ml-5 lg:py-20 mt-12'>
        <p className='font-semibold lg:text-6xl text-3xl tracking-wide text-white py-2'>FAST,<span className='text-[#FFCA05] tracking-wide'>RELIABLE</span></p>
