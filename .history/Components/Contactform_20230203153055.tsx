...
const ContactForm: React.FC = () => {
    ...
    return (
        <div className=" bg-[#FFCA05] text-black px-10 lg:px-20 py-10 lg:py-20">
            ...
            >
                ...
                <label className="text-sm lg:text-base" htmlFor="phone">
                    Your Phone
                    <span className="flex mt-2 border-2 border-black items-center pl-4 rouned">
                        <svg
                            className="w-7"
                            width="38"
                            height="38"
                ...
                <label className="text-sm lg:text-base" htmlFor="email">
                    Your Email
                    <span className="flex mt-2 border-2 border-black items-center pl-4 rounded-xl">
                        <svg
                            className="w-7"
                            width="38"
                            height="38"
                ...
                <label className="text-sm lg:text-base" htmlFor="message">
                    Your Message
                    <span className="flex mt-2 border-2 border-black items-start pt-2 pl-4 rounded-xl">
                        <svg
                            className=" w-7 -mt-2"
                            width="39"
                            height="39"
                ...
                <button
                    className="bg-[#1C2C5E] text-white border-2 mt-4 lg:mt-8 text-primary text-lg w-max px-6 py-2 
