    ...
    return (
        <div className='px-10 flex lg:flex-row flex-col mt-20 pb-10'>
            <div className='lg:w-3/5'>
                <p className='font-semibold text-5xl tracking-wide'>Why Choose</p>
                <p className='font-semibold text-5xl tracking-wide'>RHR Consol ??</p>
                <img
        ...
        drop-shadow-lg hover:scale-105 mt-4">Know More</button>
                </div>
            </div>
            <div className='lg:w-2/3 items-center'>
                <div className='grid grid-cols-2 md:grid-cols-3 md:px-10 gap-y-10 lg:gap-x-14'>
                    {
                        Data.map((d)=>(
