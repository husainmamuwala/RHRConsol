      ...
      <div className='bg-secondary w-full rounded-[2rem] md:py-10 py-5 md:px-10 px-5'>
        <div className='flex flex-row justify-between'>
          <div className=' text-white'>
            ...
            <br />
            <span className='md:text-6xl text-xl font-bold mb-10'>From Local to <span className='text-primary'> THE WORLD.</span></span>
            <br />
            <span className='text-lg tracking-wide'>RHR Consol is a logistics provider of integrated freight solutions .RHR provides dedicated freight solution including:</span>
          </div>
          <div className=''>
            <img
              src='img/arrow 1.png'
