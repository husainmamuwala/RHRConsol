...
const Cards = () => {
  const Data = [
    ...
    },
    {
        title:"Services",
        src:"service.svg",
        para:"Professional staff handles this department. Customer satisfaction has been defined as the ultimate goal. RHRs Pvt. Ltd. acts as buyers’ consolidating agent for various big and medium size buying houses spread over Europe, Scandinavia & USA."
    }
  ];
  return (
    <div>
